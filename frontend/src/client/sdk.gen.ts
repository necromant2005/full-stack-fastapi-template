...
export class MetricsService {
     ...
     */
    public static readMetricsInsights<ThrowOnError extends boolean = true>(options?: Options<metricsReadMetricsInsightsData, ThrowOnError>) {
        return (options?.client ?? client).get<metricsReadMetricsInsightsResponses, unknown, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
